...
GCLASS(NullClass, Guid("00000000-0000-0000-0000-000000000000")) {};

// This should never be used, but it is here to avoid returning reference to local variable
GENUM(NullEnum, Guid("00000000-0000-0000-0000-000000000000")) {};
...
const ClassDescription& Database::GetClass(size_t hash)
{
	...
	static auto type = refl::reflect<NullClass>();
...
const ArrayDescription& Database::GetArray(size_t hash)
{
	...
	static auto null = CreateArrayDescription<NullClass[1]>();
	return null;
}
